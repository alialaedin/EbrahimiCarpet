  ...
  <div class="col-12">
    <div class="page-header">
      <ol class="breadcrumb align-items-center">
        ...
        <li class="breadcrumb-item">ثبت هزینه جدید</li>
      </ol>
    </div>

    <div class="card">
      <div class="card-header border-0">
        <p class="card-title">ثبت هزینه جدید</p>
        <x-core::card-options/>
      </div>
      <div class="card-body">
        <form action="{{ route('admin.expenses.store') }}" method="post" class="save">
          @csrf
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="text" name="amount" id="amount" placeholder="مبلغ هزینه را به تومان  وارد کنید" class="form-control comma" value="{{ old('amount') }}">
