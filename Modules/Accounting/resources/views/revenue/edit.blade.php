        ...
        <div class="row">
          ...
          <div class="col-md-6 col-12">
            <div class="form-group">
              ...
              <input type="text" name="amount" id="amount" placeholder="مبلغ درامد را به ریال  وارد کنید" class="form-control comma" value="{{ old('amount', number_format($revenue->amount)) }}">
