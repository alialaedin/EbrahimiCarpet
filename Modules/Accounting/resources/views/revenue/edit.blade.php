...
@section('content')
  <div class="page-header">
    <ol class="breadcrumb align-items-center">
      ...
      <li class="breadcrumb-item">ویرایش درامد</li>
    </ol>
  </div>
  <div class="card">
    <div class="card-header border-0">
      <p class="card-title">ویرایش درامد - کد {{ $revenue->id }}</p>
      <x-core::card-options/>
    </div>
    <div class="card-body">
      <form action="{{ route('admin.revenues.update', $revenue) }}" method="post" class="save">
        @csrf
        @method('PATCH')
        <div class="row">
            ...
            <div class="form-group">
              ...
              <select name="headline_id" id="headline_id" class="form-control">
                @foreach ($headlines as $headline)
                  <option value="{{ $headline->id }}" @selected(old('headline_id', $revenue->headline->id) == $headline->id)>{{ $headline->title }}</option>
                @endforeach
              </select>
          ...
          <div class="col-md-6 col-12">
            <div class="form-group">
              ...
              <input type="text" name="title" id="title" placeholder="عنوان را وارد کنید" class="form-control" value="{{ old('title', $revenue->title) }}">
          ...
          <div class="col-md-6 col-12">
            <div class="form-group">
              ...
              <input type="text" name="amount" id="amount" placeholder="مبلغ درامد را به تومان  وارد کنید" class="form-control comma" value="{{ old('amount', number_format($revenue->amount)) }}">
          ...
          <div class="col-md-6 col-12">
            <div class="form-group">
              ...
              <input name="payment_date" id="payment_date" type="hidden" value="{{ old("payment_date", $revenue->payment_date) }}" required/>
          ...
          <div class="col-12">
            <div class="form-group">
              ...
              <textarea name="description" id="description" placeholder="توضیحات لازم را وارد کنید" class="form-control" rows="5"> {{ old('description', $revenue->description) }} </textarea>
