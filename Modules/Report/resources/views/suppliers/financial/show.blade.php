...
@section('content')
    ...
    <div class="row justify-content-center d-flex">
        <p class="fs-22">گزارش مالی تامین کننده با نام <b>{{ $supplier->name }}</b> و شماره همراه
            <b>{{ $supplier->mobile }}</b></p>
    </div>
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                @forelse ($supplier->purchases as $purchase)
                                    ...
                                    @php
                                        $totalPurchaseAmount += $purchase->total_items_amount_with_discount;
                                ...
                                @if ($supplier->purchases->isNotEmpty())
                                    <tr>
                                        ...
                                        <td colspan="1">
                                            {{ number_format($totalPurchaseAmount - $totalPurchaseDiscount) }}</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center">
                                            {{ number_format($cashPayments->sum('amount')) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                    ...
                                    @foreach ($chequePayments as $payment)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ config('payment.statuses.' . $payment->type . '.' . $payment->status) }}</td>
                                            <td class="text-center">{{ number_format($payment->amount) }}</td>
                                        </tr>
                                    @endforeach
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center">
                                            {{ number_format($chequePayments->sum('amount')) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center">
                                            {{ number_format($installmentPayments->sum('amount')) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
