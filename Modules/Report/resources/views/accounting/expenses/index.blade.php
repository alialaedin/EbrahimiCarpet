...
@section('content')
  ...
  <div class="card d-print-none">
    ...
    <div class="card-body">
      <div class="row">
        <form action="{{ route("admin.reports.expenses") }}" class="col-12">
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6 col-xl-4">
              <a href="{{ route("admin.reports.expenses") }}" class="btn btn-danger btn-block">حذف همه فیلتر ها <i class="fa fa-close"></i></a>
            </div>
  ...
  <div class="row justify-content-center d-none d-print-flex">
    <p class="fs-22">گزارش مالی هزینه ها</p>
  </div>
  <div class="card">
    <div class="card-body">
          ...
          <div class="row">
            <table class="table table-vcenter table-striped text-nowrap table-bordered border-bottom">
              ...
              <tr>
                ...
                <td colspan="1" class="text-center">{{ number_format($totalExpensesAmount) }}</td>
              </tr>
              </tbody>
            </table>
          </div>
