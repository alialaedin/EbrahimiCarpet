...
@section('content')
  ...
  <div class="page-header d-print-none">
    <x-core::breadcrumb :items="[
      ...
      ['title' => 'فیلتر گزارش خرید', 'route_link' => 'admin.reports.purchases-filter'],
      ['title' => 'خرید از ' . $supplier->name],
    ]"/>
          ...
          <div class="row">
            ...
            <table class="table table-vcenter table-striped text-nowrap table-bordered border-bottom">
              ...
              @forelse ($purchases as $purchase)
                ...
                @php $totalAmountWithDiscount += $purchase->total_amount; @endphp

              @empty
                <x-core::data-not-found-alert :colspan="7"/>
              @endforelse
              <tr>
                <td class="text-center font-weight-bold" colspan="6">جمع کل</td>
