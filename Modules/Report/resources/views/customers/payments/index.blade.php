...
@section('content')
  <div class="page-header d-print-none">
    <ol class="breadcrumb align-items-center">
      ...
      <li class="breadcrumb-item"><a href="{{ route('admin.reports.customer-payments-filter') }}">فیلتر گزارش دریافتی از مشتری</a></li>
  ...
  <div class="row justify-content-center d-none d-print-flex">
    <p class="fs-22">گزارش دریافتی از مشتری با نام <strong>{{ $customer->name }}</strong> و شماره
