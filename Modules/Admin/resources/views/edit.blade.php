        ...
        <x-core::breadcrumb :items="$breadcrumbItems" />
            ...
            @method('PATCH')
                    ...
                    @endforeach
							...
							<div class="col-lg-4 col-md-6">
								<div class="form-group">
									...
									<input type="password" class="form-control" name="password" placeholder="کلمه عبور را وارد کنید">
								</div>
							</div>
							<div class="col-lg-4 col-md-6">
								<div class="form-group">
									<label for="label" class="control-label"> تکرار کلمه عبور: <span class="text-danger">&starf;</span></label>
									<input type="password" class="form-control" name="password_confirmation" placeholder="تکرار کلمه عبور را وارد کنید">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
                  ...
                  <label class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" name="status" value="1" @checked($admin->status)>
