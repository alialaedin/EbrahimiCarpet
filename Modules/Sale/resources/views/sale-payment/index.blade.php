...
@section('content')
  ...
  <div class="page-header">
    <x-core::breadcrumb :items="[['title' => 'دریافتی ها']]" />
  </div>
  ...
  <x-core::card>
    <x-slot name="cardTitle">لیست تمام دریافتی ها ({{ $totalPayments }})</x-slot>
    <x-slot name="cardOptions"><x-core::card-options/></x-slot>
    <x-slot name="cardBody">
      <x-core::table>
        <x-slot name="tableTh">
        ...
        <x-slot name="tableTd">
          @forelse ($payments as $payment)
            <tr>
              ...
              <td>
                <a href="{{ route('admin.customers.show', $payment->customer->id) }}">{{ $payment->customer->name }}</a>
              </td>
  ...
  <x-sale::edit-sale-payment-modal :payments="$payments" idExtention="edit-payment-modal"/>
  <x-sale::sale-payment-description-modal :payments="$payments" idExtention="payment-description-modal"/>
