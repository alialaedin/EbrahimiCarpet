    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content modal-content-demo">
        <div class="modal-header">
          <p class="modal-title" style="font-size: 20px;">ویرایش دریافتی - کد {{ $payment->id }}</p><button aria-label="Close" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
        </div>
        <div class="modal-body">
          ...
          <form action="{{ route('admin.sale-payments.update', $payment) }}" method="POST" class="save">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="form-group">
                  <label for="description-{{ $payment->id }}" class="control-label">توضیحات :</label>
                  <textarea
                    name="description"
