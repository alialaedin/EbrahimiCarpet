            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="price" class="form-control comma" name="price" placeholder="قیمت محصول را به ریال وارد کنید" value="{{ old('price', number_format($item->price)) }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="discount" class="form-control comma" name="discount" placeholder="تخفیف را به ریال وارد کنید" value="{{ old('discount', $item->discount ? number_format($item->discount) : null) }}">
