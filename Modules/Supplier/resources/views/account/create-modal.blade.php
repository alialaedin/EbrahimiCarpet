          ...
          <div class="row">
            <div class="col-lg-6 col-12">
              <div class="form-group">
                <label for="supplier_id" class="control-label">تامین کننده :<span class="text-danger">&starf;</span></label>
                <select name="supplier_id" id="supplier_id" class="form-control select2">
                  <option value="" class="text-muted">تامین کننده را انتخاب کنید</option>
