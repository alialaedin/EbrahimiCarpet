						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="name" placeholder="نام و نام خانوادگی را وارد کنید" value="{{ old('name', $employee->name)}}" required autofocus>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="mobile" placeholder="شماره موبایل را وارد کنید" value="{{ old('mobile', $employee->mobile) }}" required>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="telephone" placeholder="تلفن ثابت را وارد کنید" value="{{ old('telephone', $employee->telephone) }}">
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="national_code" placeholder="کد ملی را وارد کنید" value="{{ old('national_code', $employee->national_code) }}" >
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control comma" name="salary" placeholder="میزان حقوق را وارد کنید" value="{{ old('salary', number_format($employee->salary)) }}" required>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="card_number" placeholder="شماره کارت را وارد کنید" value="{{ old('card_number', $employee->card_number) }}" required>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="sheba_number" placeholder="شماره شبا را وارد کنید" value="{{ old('sheba_number', $employee->sheba_number) }}">
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="bank_name" placeholder="نام بانک را وارد کنید" value="{{ old('bank_name', $employee->bank_name) }}" required>
