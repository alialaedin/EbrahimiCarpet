...
@section('content')
  <div class="col-12">
            ...
            <div class="row">
              <table class="table table-vcenter text-nowrap table-bordered border-bottom">
                ...
                <tr>
                  ...
                  <th class="text-center">مبلغ فروش ها (تومان)</th>
                  <th class="text-center">تخفیف کلی (تومان)</th>
                  <th class="text-center">مبلغ فروش ها با تخفیف (تومان)</th>
                  <th class="text-center">تاریخ فروش ها</th>
    ...
    <div class="card">
      <div class="card-header border-0">
        <p class="card-title ml-2">پرداختی ها <span class="fs-15">({{ $salePaymentsCount }})</span></p>
        <x-core::card-options/>
      </div>
      <div class="card-body">
        <div class="table-responsive">
