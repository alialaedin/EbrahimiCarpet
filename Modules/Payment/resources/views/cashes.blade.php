...
@section('content')
  ...
  <div class="page-header">
    <x-core::breadcrumb :items="[['title' => 'نقدی های پرداختی به تامین کننده']]" />
  </div>
  ...
  <x-payment::edit-payment-modal :payments="$cashPayments" idExtention="edit-payment-modal"/>
  <x-payment::payment-description-modal :payments="$cashPayments" idExtention="payment-description-modal"/>
